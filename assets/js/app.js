(function () {
  var CART_KEY = "hightac-jogijogijogijogijogi-cart-v1";
  var SUBMISSION_KEY = "hightac-jogijogijogijogijogi-last-submission-v1";
  var LANG_KEY = "hightac-jogijogijogijogijogi-language-v1";
  var DEFAULT_LANG = "fr";
  ...
  var LOCALES = {
    fr: {
      ...
      title_parts: "Pièces JogiJogiJogiJogiJogi",
    ...
    en: {
      ...
      title_parts: "JogiJogiJogiJogiJogi Parts",
      title_success: "WhatsApp",
    ...
    ar: {
      ...
      title_parts: "قطع JogiJogiJogiJogiJogi",
  ...
  function getCatalog() {
    ...
    return {
      model: {
        name: "JogiJogiJogiJogiJogi",
        motorPicture: "Database/MotorPictures/JogiJogiJogiJogiJogi.png"
      },
      parts: []
    };
  }
  ...
  function submitCart() {
    ...
    var modelName = state.catalog.model.name || "JogiJogiJogiJogiJogi";
